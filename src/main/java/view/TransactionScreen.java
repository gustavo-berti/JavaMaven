			...
			case 2:
				...
				switch (type2){
					case 1:
						...
						List<Transaction> transactions = controller.balanceInquiryMonth(transaction.getAccountHolderCpf(), month, year);
					...
					case 2:
						...
						List<Transaction> transactions2 = controller.balanceInquiryPeriod(transaction.getAccountHolderCpf(), startDate, endDate);
